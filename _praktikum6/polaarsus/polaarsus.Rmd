...
Laadi alla andmestik [*Riigikogu_XIII.csv*](../data/Riigikogu_XII.csv) ja loe töökeskkonda.

### Ülesanne 1 (2 punkt) - andmestiku mudimine

a) Muuda tunnused numbriliseks. Selleks kodeeri hääletused järgmiselt:
...
### Ülesanne 2 (3 punkti) - visualiseeri andmeid heatmapi abil
