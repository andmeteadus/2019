...
* `polintr` -- Kui huvitatud Te olete poliitikast?
* `trstprl` -- Kuivõrd Te usaldate järgmisi Eesti riigikogu?
* `trstlgl` -- Kuivõrd Te usaldate järgmisi Eesti õigussüsteemi?
* `trstplc` -- Kuivõrd Te usaldate järgmisi Eesti politseid?
* `trstplt` -- Kuivõrd Te usaldate järgmisi Eesti poliitikuid?
* `trstprt` -- Kuivõrd Te usaldate järgmisi Eesti poliitilisi parteisid ja erakondi?
* `trstep`  -- Kuivõrd Te usaldate järgmisi Euroopa parlamenti?
...
### Ülesanne 6 (5 punkti) - shiny rakendus (TÄIENEB VEEL)

Esita eelmises ülesandes leitud joonis shiny rakendusena.

### Ülesanne 7 (5 punkti) - shiny rakenduse täiendus (TÄIENEB VEEL)
