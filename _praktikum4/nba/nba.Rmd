...
### Ülesanne 1 - väljak diskreetseks (2 punkti)
...
### Ülesanne 2 - mänguväljaku põhja lisamine (2 punkti)
...
### Ülesanne 3 - suuruse muutmine (2 punkti)
...
### Ülesanne 5 - kuusnurgad (3 punkti)
...
### Ülesanne 6 - shiny rakendus (3 punkti)
...
* Tekita esmalt võimalus meeskonna valikuks
...
* Tekita juurde võimalus mängija valikuks. Kasutajale kuvatakse vaid neid mängijaid, kes kuuluvad (või on hooaja jooksul kuulunud) valitud meeskonda.
...
```{r, eval = FALSE}
  observe({
    ...
    # Sinu kood
    ## Vali välja nende mängijate nimed, kes kuuluvad (või on kuulunud) valitud meeskonda
    ## mangijad_meeskonnas = ...
...
* Väljasta valitud meeskonna ja mängija viskeprofiili joonis (vt ülesanne 5).
* Eemalda jooniselt kõik üleliigne (telgede tekst, tick’d, joonise raam ja ruudustik (grid)). Kasuta selleks funktsiooni `theme()`.
...
### Boonusülesanne 1 - mängijate valik (2 punkt)
...
### Boonusülesanne 2 - geomeetria (1 punkt)
