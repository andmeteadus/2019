...
`ggplot()` võimaldab parameetri `shape` abil määrata vaatlusele erinevaid geomeetrilisi kujutusviise, kuid valikutes ei leidu kuusnurka. Oleme ette andnud funktsiooni `kuusnurk`, mis sisestades keskpunkti koordinaadid ja pindala, väljatab kuusnurga tippude koordinaadid. Ise defineeritud geomeetriliste objektide kujutamiseks `geom_point()` ei sobi. 

Näpunäide:

* uuri, mida teeb käsk `geom_polygon()`
