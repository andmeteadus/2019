...
Näide, kuidas joonistada suurringjoont R-is. Ühendame Liivi 2 maja Eyjafjallajökulliga kasutades `ggmap()` funktsiooni. Loe rohkem `ggmap()` funktsiooni kohta [siit.](https://journal.r-project.org/archive/2013-1/kahle-wickham.pdf/)
...
Näide, kuidas joonistada suurringjoont R-is. Ühendame Liivi 2 maja maailma suurima pitsa sünnikohaga kahutades `leaflet` paketti. Loe rohkem `leaflet`'i kohta [siit.](https://rstudio.github.io/leaflet/)
...
![alt text](otselend_voi_yks_vahepeatus.png "Näide1")

või selline:

![alt text](otselend_voi_yks_vahepeatus2.png "Näide2")
