...
Nüüd kirjuta funktsioon *kauplemisalgoritm_turvaline*, kus valid atraktiivseid aktsiaid vaid populaarsete aktsiate hulgast. Populaarsed aktsiad on järgnevad: AAPL, FB, GOOG, IBM. 

Juhised:

* Vali andmestikust välja ainult aktsiad AAPL, FB, GOOG, IBM.
...
Muuda kodutööd selliselt, et staatilise faili *aktsiad.csv* asemel kasutatakse reaalajas andmeid, mis on saadud portaalist *finance.yahoo.com*.
...
* ettevõtte *sektor*, *nimi* ja *aktsiate_arv* võta failist *aktsiad.csv*. Ühenda see alamandmestik Yahoo'st saadud andmestikuga tunnuse *symbol* alusel (vt`?join` või `?merge`)
